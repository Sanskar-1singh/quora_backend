...
async function deleteAns(req,res){
    try {
        const response=await this.answerService.getansDelete(req.params.que,req.params.ans);
        SuccessResponse.data=response;
        SuccessResponse.message="Successfully deleted the answer for the question";
